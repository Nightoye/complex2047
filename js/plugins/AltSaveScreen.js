...
(function() {
    ...
    Scene_File.prototype.create = function() {
        ...
        this._listWindow.height = this._listWindow.fittingHeight(8);				this._listWindow.x=36;
	this._listWindow.y+=24;
	this._listWindow.opacity=0;
	this._listWindow.width=744;
	this._helpWindow.x=36;
	this._helpWindow.y=24;
	this._helpWindow.opacity=0;
	this._helpWindow.width=744;
	//this._listWindow.height=576;
        var x = 36;
